...
Tags: contact form builder, form builder, contact form 7, survey
...
= 1.2.11 =
* Fixed issue with WP subscribers being able to access non-public forms

= 1.2.10 =
* Fixed form alignment issue and XSS security issue

= 1.2.9 =
* Removed nag function

= 1.2.8 =
* Fixed nopriv function issue

= 1.2.7 =
* Fixed admin XSS security issue(s)
